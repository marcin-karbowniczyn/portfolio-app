...
with col2:
    ...
    I have some experience in working with such frameworks and libraries like Django, Django Web Framework, Flask, Docker, Pandas, Jupyter, ExpressJS, Sqlite3, MySQL and Mongoose.
